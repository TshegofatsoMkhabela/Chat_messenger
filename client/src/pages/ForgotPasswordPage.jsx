    ...
    return (
        ...
        >
                ...
                {!isSubmitted ? (
                    ...
                    <div className='text-center'>
                        <motion.div
                            ...
                            className='w-16 h-16 bg-[#5a0f85] rounded-full flex items-center justify-center mx-auto mb-4'
                        >
            ...
            <div className='px-8 py-4 bg-gray-50 flex justify-center'>
                <Link to={"/login"} className='text-sm text-[#5a0f85] flex items-center hover:underline'>
